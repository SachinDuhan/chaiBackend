...
const getCurrentUser = asyncHandler( async(req, res) => {
    ...
    .json(
        200,
        req.user,
        "current usr fetched successfully"
    )
} )
...
const updateUserAvatar = asyncHandler( async(req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200, newAvatar, "Avatar updated successfully")
    )
} )
...
const updateUserCoverImage = asyncHandler( async(req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200, newCoverImage, "Cover Image updated successfully")
    )
} )
